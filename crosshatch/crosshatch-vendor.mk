...
PRODUCT_COPY_FILES := \
    ...
    vendor/google/crosshatch/proprietary/bin/seempd:system/bin/seempd \
    ...
    vendor/google/crosshatch/proprietary/etc/felica/mfs.cfg:system/etc/felica/mfs.cfg \
    ...
    vendor/google/crosshatch/proprietary/etc/init/bufferhubd.rc:system/etc/init/bufferhubd.rc \
    vendor/google/crosshatch/proprietary/etc/init/performanced.rc:system/etc/init/performanced.rc \
    vendor/google/crosshatch/proprietary/etc/init/virtual_touchpad.rc:system/etc/init/virtual_touchpad.rc \
    vendor/google/crosshatch/proprietary/etc/init/vr_hwc.rc:system/etc/init/vr_hwc.rc \
    vendor/google/crosshatch/proprietary/etc/permissions/android.hardware.sensor.assist.xml:system/etc/permissions/android.hardware.sensor.assist.xml \
    vendor/google/crosshatch/proprietary/etc/permissions/android.hardware.telephony.euicc.xml:system/etc/permissions/android.hardware.telephony.euicc.xml \
    ...
    vendor/google/crosshatch/proprietary/etc/permissions/com.android.sdm.plugins.connmo.xml:system/etc/permissions/com.android.sdm.plugins.connmo.xml \
    ...
    vendor/google/crosshatch/proprietary/etc/permissions/com.verizon.apn.xml:system/etc/permissions/com.verizon.apn.xml \
    vendor/google/crosshatch/proprietary/etc/permissions/com.verizon.embms.xml:system/etc/permissions/com.verizon.embms.xml \
    vendor/google/crosshatch/proprietary/etc/permissions/com.verizon.llkagent.xml:system/etc/permissions/com.verizon.llkagent.xml \
    ...
    vendor/google/crosshatch/proprietary/etc/permissions/com.verizon.services.xml:system/etc/permissions/com.verizon.services.xml \
    ...
    vendor/google/crosshatch/proprietary/etc/permissions/obdm_permissions.xml:system/etc/permissions/obdm_permissions.xml \
    ...
    vendor/google/crosshatch/proprietary/framework/PowerAnomalyQcril.jar:system/framework/PowerAnomalyQcril.jar \
    vendor/google/crosshatch/proprietary/lib/dsp/elmyra.so:system/lib/dsp/elmyra.so \
    ...
    vendor/google/crosshatch/proprietary/lib/vndk-28/libprotobuf-cpp-full.so:system/lib/vndk-28/libprotobuf-cpp-full.so \
    ...
    vendor/google/crosshatch/proprietary/lib/libprotobuf-cpp-full-rtti.so:system/lib/libprotobuf-cpp-full-rtti.so \
    vendor/google/crosshatch/proprietary/lib/libqcbor.so:system/lib/libqcbor.so \
    vendor/google/crosshatch/proprietary/lib/libqct_resampler.so:system/lib/libqct_resampler.so \
    ...
    vendor/google/crosshatch/proprietary/lib/libsecureuisvc_jni.so:system/lib/libsecureuisvc_jni.so \
    vendor/google/crosshatch/proprietary/lib/libsecureui_svcsock_system.so:system/lib/libsecureui_svcsock_system.so \
    vendor/google/crosshatch/proprietary/lib/libsensorslog.so:system/lib/libsensorslog.so \
    vendor/google/crosshatch/proprietary/lib/libsmcinvokecred.so:system/lib/libsmcinvokecred.so \
    vendor/google/crosshatch/proprietary/lib/libsns_low_lat_stream_stub.so:system/lib/libsns_low_lat_stream_stub.so \
    ...
    vendor/google/crosshatch/proprietary/lib/vendor.google.wireless_charger@1.0.so:system/lib/vendor.google.wireless_charger@1.0.so \
    ...
    vendor/google/crosshatch/proprietary/lib/vendor.qti.hardware.qdutils_disp@1.0.so:system/lib/vendor.qti.hardware.qdutils_disp@1.0.so \
    ...
    vendor/google/crosshatch/proprietary/lib/vendor.qti.hardware.radio.lpa@1.0.so:system/lib/vendor.qti.hardware.radio.lpa@1.0.so \
    ...
    vendor/google/crosshatch/proprietary/lib/vendor.qti.voiceprint@1.0.so:system/lib/vendor.qti.voiceprint@1.0.so \
    vendor/google/crosshatch/proprietary/lib64/vndk-28/libprotobuf-cpp-full.so:system/lib64/vndk-28/libprotobuf-cpp-full.so \
    ...
    vendor/google/crosshatch/proprietary/lib64/libDiagService.so:system/lib64/libDiagService.so \
    ...
    vendor/google/crosshatch/proprietary/lib64/libprotobuf-cpp-full-rtti.so:system/lib64/libprotobuf-cpp-full-rtti.so \
    vendor/google/crosshatch/proprietary/lib64/libqcbor.so:system/lib64/libqcbor.so \
    ...
    vendor/google/crosshatch/proprietary/lib64/libsecureuisvc_jni.so:system/lib64/libsecureuisvc_jni.so \
    vendor/google/crosshatch/proprietary/lib64/libsecureui_svcsock_system.so:system/lib64/libsecureui_svcsock_system.so \
    vendor/google/crosshatch/proprietary/lib64/libsensorslog.so:system/lib64/libsensorslog.so \
    vendor/google/crosshatch/proprietary/lib64/libsmcinvokecred.so:system/lib64/libsmcinvokecred.so \
    vendor/google/crosshatch/proprietary/lib64/libsns_low_lat_stream_stub.so:system/lib64/libsns_low_lat_stream_stub.so \
    ...
    vendor/google/crosshatch/proprietary/lib64/vendor.google.wireless_charger@1.0.so:system/lib64/vendor.google.wireless_charger@1.0.so \
    ...
    vendor/google/crosshatch/proprietary/lib64/vendor.qti.hardware.qdutils_disp@1.0.so:system/lib64/vendor.qti.hardware.qdutils_disp@1.0.so \
    ...
    vendor/google/crosshatch/proprietary/lib64/vendor.qti.hardware.radio.lpa@1.0.so:system/lib64/vendor.qti.hardware.radio.lpa@1.0.so \
